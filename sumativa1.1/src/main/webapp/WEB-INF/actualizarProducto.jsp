			...
			<form action="/actualizarProductos" method="POST">
			 ...
			 <div class="mb-3" hidden>
			  ...
			  <div class="mb-3">
			    ...
			    <input type="text" value="${descripcion}" class="form-control" id="descripcion" name="descripcion" required="required">
			  ...
			  <div class="mb-3">
			    ...
			    <input type="text" value="${precio}" class="form-control" id="precio" name="precio" required="required">
